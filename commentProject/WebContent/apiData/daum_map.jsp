...
<body>
	...
	String facilityName = request.getParameter("fN");
	%>
	<div id="map" style="width: 100%; height: 620px;"></div>

	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=bcdbba026b4a5298c6b773068ac6ac8e"></script>
	<script>
		var x_p = '<%=x_pos%>';
		var y_p = '<%=y_pos%>';
		var facilityN = '<%=facilityName%>';
		...
		var iwContent = '<div style="padding:5px; height:80px">'+facilityN+'<br><a href="https://map.kakao.com/link/map/Hello World!,'+x_p+','+y_p+'" style="color:blue" target="_blank">큰지도보기</a> <a href="https://map.kakao.com/link/to/Hello World!,33.450701,126.570667" style="color:blue" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
